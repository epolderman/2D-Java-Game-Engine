...
public class DifficultyTitle {
    ...
    public DifficultyTitle(double x, double y)
    {
        this.x = x;
        this.y = y;
    ...
    private void initialize()
    {
        ...
        {   
            ...
            yessir[0] = controlconsole.grabSprite128(3, 2, 128, 128);
            
            clicked[0] = controlconsole.grabSprite128(2, 2, 128, 128);
