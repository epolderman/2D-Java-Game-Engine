 ...
 * @author eze
 */
public class MissilesExplosion extends ShellExplosion
{
     ///inheriting all the instance variables
    private BufferedImage[] bimageArray = new BufferedImage[4];
    
    public MissilesExplosion(double x, double y)
    {   
        this.expired = 0;
        duration = new Time();
        this.x = x;
        ...
        initialize();
        duration.startM();
        Animation = new Anime(bimageArray[0], bimageArray[1], bimageArray[2],bimageArray[3], 10);
    }
    ...
    public void initialize()
    {
        ...
        {   
            ...
            bimageArray[3] = SpriteSheet.grabSprite64(4, 4, 64, 64);
