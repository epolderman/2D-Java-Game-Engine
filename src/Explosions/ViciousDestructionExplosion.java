 ...
 * @author eze
 */
public class ViciousDestructionExplosion extends ShellExplosion
{
    
    ///inheriting all the instance variables
    private BufferedImage[] bimageArray = new BufferedImage[3];
    
    public ViciousDestructionExplosion(double x, double y)
    {   
        this.expired = 0;
        duration = new Time();
        this.x = x;
    ...
    public void initialize()
    {
        ...
        {   
            ...
            bimageArray[0] = SpriteSheet.grabSprite256(1, 1, 256, 256);
            bimageArray[1] = SpriteSheet.grabSprite256(2, 1, 256, 256);
            bimageArray[1] = SpriteSheet.grabSprite256(3, 1, 256, 256);
