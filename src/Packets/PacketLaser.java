 ...
 * @author eze
 */
public class PacketLaser extends Packet
{
    ...
    {
        System.out.println("Number Parse Error in Laser Packet");
    }
    }
    
    public PacketLaser(String username, double x, double y)
    {
    super(03);
